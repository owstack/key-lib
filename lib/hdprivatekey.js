...
function HDPrivateKey(arg) {
  ...
  if (!arg) {
    return this._generateRandomly(Networks.defaultNetwork);
  }
...
HDPrivateKey.prototype._buildFromBuffers = function(arg) {
  ...
  var n = _.cloneDeep(this.network);
...
HDPrivateKey.prototype.toObject = HDPrivateKey.prototype.toJSON = function toObject() {
  return {
    network: Networks.get(BufferUtil.integerFromBuffer(this._buffers.version), 'version.xprivkey').name,

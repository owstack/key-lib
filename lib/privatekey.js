...
try {
  ...
  throw err;
    ...
    throw new TypeError('Must specify the network'+err.stack);
}
//    throw new TypeError('Must specify the network');
  }
...
PrivateKey.prototype.decryptBIP38PrivateKey = function(encryptedPrivateKeyBase58, passphrase, opts, cb) {
  var bip38 = new Bip38();
  var privateKeyWif;
